...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '10d73cbaa39c80c8985be89087b30805,en:10d73cbaa39c80c8985be89087b30805',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '~ 1228 ~', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '1228 win win win', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://hi1228.com', // 网站地址
  ...
  VERSION: process.env.NEXT_PUBLIC_VERSION // 版本号 // 傻逼李多扬, 你 tmd 装你牛魔
}
